...
$TABLES = array(
    ...
    'locations' => array(
        ...
        'fields' => array(
            ...
            /* if you like to test the postgis extension: */
            // 'spot' => array('label' => 'Spot', 'type' => T_POSTGIS_GEOM, 'SRID' => '4326',
            // 'help' => 'Enter text representation of geometry, e.g. POINT(-71.06 32.4485).
            // See <a href="http://postgis.net/docs/ST_GeomFromText.html" target="_blank">here</a> for help.'),
            'pretty' => array('label' => 'Is this Pretty?', 'type' => T_ENUM, 'default' => '0', 'values' =>
                array('1' => 'Yes', '0' => 'No')),
